...
//  QUICK(1, R.string.main_tab_name_quick, R.drawable.tab_icon_new,null),
	ORDER(1, R.string.main_tab_name_order, R.drawable.tab_icon_order, FunctionFragment.class, new Bundle()),
	PRODUCT(2, R.string.main_tab_name_product, R.drawable.tab_icon_func, FunctionFragment.class, new Bundle()),
