...
public class FunctionFragment extends WebViewlFragment<String> {
    ...
    public void initData() {
        ...
        if (argus != null && argus.get("dialog") != null) {
            ...
            sb.append("<script type=\"text/javascript\" src=\"file:///android_asset/uimaster/js/controls/swiper/swiper.jquery.js\"></script>\n");
            ...
            sb.append("</head>\n");
            sb.append("<body>\n");
            sb.append("<form action=\"#\" method=\"post\" name=\"everything\" style=\"height:").append(AppConfig.getScreenHeight());
            sb.append("px;overflow-y:auto;\" onsubmit=\"return false;\" _framePrefix=\"").append(argus.getString("_framePrefix")).append("\">\n");
