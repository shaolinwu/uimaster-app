...
public class Constants {
    ...
    public static final String INTENT_ACTION_USER_CHANGE = "action.USER_CHANGE";

    public static final String INTENT_ACTION_COMMENT_CHANGED = "action.COMMENT_CHANGED";

    public static final String INTENT_ACTION_NOTICE = "action.APPWIDGET_UPDATE";
