...
import org.shaolin.uimaster.app.adapter.MessageDetailAdapter;
...
public class MessageDetailFragment extends BaseListFragment<Comment> implements
    ...
    protected void sendRequestData() {
        RService.getCommentList(mFid, mCatalog, mCurrentPage, mHandler);
    }
    ...
    class DeleteMessageAsyncHandler extends AsyncResponseHandler {
        ...
        public DeleteMessageAsyncHandler(Object... args) {
            super(args);
        }
    ...
    public void onClickSendButton(Editable str) {
        ...
        showWaitDialog("提交中...");
        RService.publicMessage(AppContext.getInstance().getLoginUid(), mFid,
